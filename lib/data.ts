...
export const skillCategories: SkillCategory[] = [
  {
    ...
    items: [
      ...
      { part: "A5", name: "Internet & Web Technologies", status: "core" },
      { part: "A6", name: "Web Development-I", status: "core" },
      { part: "A7", name: "Web Development-II", status: "core" },
      { part: "A8", name: "Application Development using Full Stack", status: "core" },
  ...
  },
  {
    ...
    items: [
      ...
      { part: "B4", name: "Data Structures", status: "core" },
      { part: "B5", name: "Object-Oriented Programming", status: "core" },
      { part: "B6", name: "Computer Architecture", status: "core" },
      { part: "B7", name: "Operating Systems", status: "core", note: "undergrad + graduate" },
      { part: "B8", name: "Systems Programming", status: "core" },
      { part: "B9", name: "Microprocessor & Assembly Language", status: "core" },
      { part: "B10", name: "Fundamentals of Embedded Systems & IoT", status: "core" },
      { part: "B11", name: "Computer Network", status: "core" },
    ],
  },
  {
    code: "SHEET C",
    ...
    items: [
      { part: "C1", name: "SQL", status: "core" },
      { part: "C2", name: "AWS EC2 / cloud computing", status: "learning", note: "used in production" },
      { part: "C3", name: "Introduction to DBMS", status: "core" },
      { part: "C4", name: "RDBMS", status: "core" },
      { part: "C5", name: "Database Systems", status: "core" },
      { part: "C6", name: "Advanced Database Systems", status: "completed" },
    ],
  },
  {
    code: "SHEET D",
  ...
  },
  {
    ...
    items: [
      { part: "E1", name: "Mathematics-I", status: "core" },
      { part: "E2", name: "Mathematics-II", status: "core" },
      { part: "E3", name: "Fundamentals of Computer", status: "core" },
      { part: "E4", name: "Fundamentals of Programming using C-I", status: "core" },
      { part: "E5", name: "Fundamentals of Programming using C-II", status: "core" },
      { part: "E6", name: "Fundamentals of Electronics", status: "core" },
      { part: "E7", name: "Computer Graphics", status: "completed" },
      { part: "E8", name: "System Analysis & Design", status: "core" },
      { part: "E9", name: "Optimization Techniques", status: "core" },
      { part: "E10", name: "Software Engineering", status: "core", note: "undergrad + graduate" },
    ],
  },
  {
    code: "SHEET F",
