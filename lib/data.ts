export type Proficiency = "core" | "production" | "learning" | "completed";
...
export const skillCategories: SkillCategory[] = [
  {
    ...
    description: "What I build interfaces and products with — languages, frameworks, and the coursework behind them.",
    items: [
      ...
      { part: "A5", name: "Internet & Web Technologies", status: "completed" },
      { part: "A6", name: "Web Development-I", status: "completed" },
      { part: "A7", name: "Web Development-II", status: "completed" },
      { part: "A8", name: "Application Development using Full Stack", status: "completed" },
      { part: "A9", name: "Java Web Development", status: "completed" },
      { part: "A10", name: "Enterprise Java", status: "completed" },
      { part: "A11", name: "ASP.NET", status: "completed" },
      { part: "A12", name: "VB.NET", status: "completed" },
      { part: "A13", name: "Android Software Engineering", status: "completed" },
      { part: "A14", name: "Smart Device Computing using iOS", status: "completed" },
    ],
  },
  {
    code: "SHEET B",
    title: "Systems, Structures & Architecture",
    ...
    items: [
      ...
      { part: "B4", name: "Data Structures", status: "completed" },
      { part: "B5", name: "Object-Oriented Programming", status: "completed" },
      { part: "B6", name: "Computer Architecture", status: "completed" },
      { part: "B7", name: "Operating Systems", status: "completed", note: "undergrad + graduate" },
      { part: "B8", name: "Systems Programming", status: "completed" },
      { part: "B9", name: "Microprocessor & Assembly Language", status: "completed" },
      { part: "B10", name: "Fundamentals of Embedded Systems & IoT", status: "completed" },
      { part: "B11", name: "Computer Network", status: "completed" },
    ],
  },
  {
    code: "SHEET C",
    title: "Data, Databases & Cloud",
    description: "Where the product actually runs, and where the information lives.",
    items: [
      { part: "C1", name: "SQL", status: "production" },
      { part: "C2", name: "AWS EC2 / cloud computing", status: "production", note: "used in production" },
      { part: "C3", name: "CMS platforms", status: "production" },
      { part: "C4", name: "Introduction to DBMS", status: "completed" },
      { part: "C5", name: "RDBMS", status: "completed" },
      { part: "C6", name: "Database Systems", status: "completed" },
      { part: "C7", name: "Advanced Database Systems", status: "completed" },
    ],
  },
  {
    code: "SHEET D",
    title: "AI & Emerging Tech",
    description: "Languages and fields I'm still building depth in, plus the coursework that started it.",
    items: [
      { part: "D1", name: "Python", status: "learning" },
      { part: "D2", name: "Go", status: "learning" },
      { part: "D3", name: "Rust", status: "learning" },
      { part: "D4", name: "Artificial Intelligence", status: "completed", note: "undergrad + graduate" },
      { part: "D5", name: "Big Data Analytics", status: "completed" },
    ],
  },
  {
    code: "SHEET E",
    title: "Foundations & Theory",
    description: "The math and fundamentals underneath everything else on this sheet.",
    items: [
      { part: "E1", name: "Mathematics-I", status: "completed" },
      { part: "E2", name: "Mathematics-II", status: "completed" },
      { part: "E3", name: "Fundamentals of Computer", status: "completed" },
      { part: "E4", name: "Fundamentals of Programming using C-I", status: "completed" },
      { part: "E5", name: "Fundamentals of Programming using C-II", status: "completed" },
      { part: "E6", name: "Fundamentals of Electronics", status: "completed" },
      { part: "E7", name: "Computer Graphics", status: "completed" },
      { part: "E8", name: "System Analysis & Design", status: "completed" },
      { part: "E9", name: "Optimization Techniques", status: "completed" },
      { part: "E10", name: "Software Engineering", status: "completed", note: "undergrad + graduate" },
    ],
  },
  {
    code: "SHEET F",
    title: "Product & Responsible Computing",
    description: "Building for real users, and the rules and access questions that come with it.",
    items: [
      { part: "F1", name: "Accessibility-focused development", status: "core", note: "core to how I work" },
      { part: "F2", name: "E-Business & Cyber Laws", status: "completed" },
    ],
  },
];
