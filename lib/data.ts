...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    description: "What the current degree is actually built from.",
    items: [
      { part: "E1", name: "Android Software Engineering", status: "completed" },
      { part: "E2", name: "Artificial Intelligence", status: "completed" },
      { part: "E3", name: "Computer Architecture", status: "completed" },
      { part: "E4", name: "Database Systems", status: "completed" },
      { part: "E5", name: "Operating Systems", status: "completed" },
      { part: "E6", name: "Advanced Database Systems", status: "completed" },
      { part: "E7", name: "Software Engineering", status: "completed" },
      { part: "E8", name: "Big Data Analytics", status: "completed" },
      { part: "E9", name: "Systems Programming", status: "completed" },
    ],
  },
  {
    code: "SHEET F",
    title: "Undergraduate Coursework",
    description: "The foundation everything above is built on.",
    items: [
      { part: "F1", name: "Mathematics-I", status: "completed" },
      { part: "F2", name: "Fundamentals of Computer", status: "completed" },
      { part: "F3", name: "Fundamentals of Programming using C-I", status: "completed" },
      { part: "F4", name: "Internet & Web Technologies", status: "completed" },
      { part: "F5", name: "Mathematics-II", status: "completed" },
      { part: "F6", name: "Fundamentals of Programming using C-II", status: "completed" },
      { part: "F7", name: "Introduction to DBMS", status: "completed" },
      { part: "F8", name: "Fundamentals of Electronics", status: "completed" },
      { part: "F9", name: "Microprocessor & Assembly Language", status: "completed" },
      { part: "F10", name: "Data Structures", status: "completed" },
      { part: "F11", name: "Object-Oriented Programming", status: "completed" },
      { part: "F12", name: "Computer Network", status: "completed" },
      { part: "F13", name: "Fundamentals of Embedded Systems & IoT", status: "completed" },
      { part: "F14", name: "VB.NET", status: "completed" },
      { part: "F15", name: "Web Development-I", status: "completed" },
      { part: "F16", name: "Web Development-II", status: "completed" },
      { part: "F17", name: "RDBMS", status: "completed" },
      { part: "F18", name: "Computer Graphics", status: "completed" },
      { part: "F19", name: "System Analysis & Design", status: "completed" },
      { part: "F20", name: "Java", status: "completed" },
      { part: "F21", name: "ASP.NET", status: "completed" },
      { part: "F22", name: "Operating System", status: "completed" },
      { part: "F23", name: "E-Business & Cyber Laws", status: "completed" },
      { part: "F24", name: "Application Development using Full Stack", status: "completed" },
      { part: "F25", name: "Software Engineering", status: "completed" },
      { part: "F26", name: "Optimization Techniques", status: "completed" },
      { part: "F27", name: "Java Web Development", status: "completed" },
      { part: "F28", name: "Enterprise Java", status: "completed" },
      { part: "F29", name: "Smart Device Computing using iOS", status: "completed" },
      { part: "F30", name: "Artificial Intelligence", status: "completed" },
    ],
  },
];
